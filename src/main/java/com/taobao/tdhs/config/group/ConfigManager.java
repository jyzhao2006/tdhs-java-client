...
import com.taobao.tdhs.client.TDHSClientAtomImp;
...
public class ConfigManager {
	...
	private List<TDHSClient> atomTdhsClient = new ArrayList<TDHSClient>();
	...
	public void init() {
		...
		for(String db : dbArray)
		{
			...
			int w = weight.w;
			TDHSClientAtomImp one = new TDHSClientAtomImp();
			try {
	...
	public List<TDHSClient> getAtomTdhsClient() {
		return atomTdhsClient;
	}
	public void setAtomTdhsClient(List<TDHSClient> atomTdhsClient) {
